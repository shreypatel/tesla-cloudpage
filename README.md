...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/tesla-cloudpage)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/tesla-cloudpage
```

A live public deployment of this template is available at [https://tesla-cloudpage.templates.workers.dev](https://tesla-cloudpage.templates.workers.dev)
